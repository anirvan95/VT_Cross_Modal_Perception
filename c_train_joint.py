...
from utils.joint_latent_filter import MMLF
...
def main():
    ...
    parser.add_argument('--save', default=os.path.join('results', 'joint'), help='Path to save the models')
    ...
    while iteration < num_iterations:
        for i, values in enumerate(train_loader):
            ...
            if iteration % args.log_freq == 0:
                ...
                if args.validate:
                    mmlf.eval()
                    validate_baseline(val_loader, mmlf, out_dir, iteration, save_plot=args.saveplots, show_plot=args.showplots, vis=vis)
