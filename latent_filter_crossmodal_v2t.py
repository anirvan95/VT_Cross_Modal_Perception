...
class CrossModalLF(nn.Module):
    def __init__(self, args):
        ...
        # self.vis_z2tac_y = CMFunction(input_dim=self.vis_dim_z, output_dim=self.tac_dim_y * self.tac_q_dist_y.nparams)
    ...
    def filter(self, vis_x, tac_x, u, labels, H):
        ...
        for t in range(1, T):
            ...
            if H == 1:
                ...
                tac_y_params_t_1_ref = bayes_fusion(vis2tac_y_params_t_1, tac_y_params_t_1, self.cm_fusion_weight) # visual prior, tactile likelihood
            ...
            vis_y_params_f.append(vis_y_params_t_1)
        ...
        return (vis_prior_params_y_f, vis_y_params_f, vis_ys_f, vis_prior_params_z_f, vis_z_params_f,
                ...
                vis2tac_y_params_f, lsttac_y_params_f)
