...
def main():
    mmlf_base_results_path = os.path.join('results', 'joint', 'vt')
    ...
    val_dir = os.path.join('dataset','cm_dataset','testing')
    ...
    for i, checkpoint in enumerate(checkpoints):
        ...
        for noise in noises:
            ...
            np.savez(os.path.join(mmlf_base_results_path, 'surprise_output', str(iteration) + '_n'+str(noise)+'_c'+str(corruption)+'.npz'),
                     y_params=y_params,
