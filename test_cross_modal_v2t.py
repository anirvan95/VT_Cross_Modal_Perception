...
def main():
    cmlf_base_results_path = os.path.join('results', 'crossmodal', 'v2t_weight') # v2t_early
    ...
    for i, checkpoint in enumerate(checkpoints):
        ...
        np.savez(os.path.join(cmlf_base_results_path, 'surprise_output', str(iteration) + '_n'+str(noise)+'_c'+str(corruption)+'.npz'),
