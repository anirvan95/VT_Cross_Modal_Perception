...
class CMLF(nn.Module):
    def __init__(self, args):
        super(CMLF, self).__init__()
        ...
        # ##############################################################################################################
        # Cross Modal Transfer Functions
        ...
        self.transition_net = MLPTransition(input_dim=self.vis_dim_z + self.vis_dim_y + self.tac_dim_z + self.tac_dim_y +self.dim_a,
    ...
    def filter(self, vis_x, tac_x, u, labels, H):
        ...
        for t in range(1, T):
            ...
            vis_ys_t_1 = self.vis_q_dist_y.sample(params=vis_y_params_t_1)
            ...
            if H == 1:
                ...
                vis_y_params_t_1_ref = bayes_fusion(tac2vis_y_params_t_1, vis_y_params_t_1, self.cm_fusion_weight)
                tac2vis_y_params_f.append(tac2vis_y_params_t_1)
                lstvis_y_params_f.append(vis_y_params_t_1)
                # CM-V2T
                vis2tac_y_params_t_1 = self.vis_y2tac_y.forward(vis_ys_t_1).view(batch_size, self.tac_dim_y, self.tac_q_dist_y.nparams)
                tac_y_params_t_1_ref = bayes_fusion(vis2tac_y_params_t_1, tac_y_params_t_1, self.cm_fusion_weight)
                vis2tac_y_params_f.append(vis2tac_y_params_t_1)
                lsttac_y_params_f.append(tac_y_params_t_1)
            else:
                vis_y_params_t_1_ref = vis_y_params_t_1
                tac2vis_y_params_f.append(vis_y_params_t_1)
                lstvis_y_params_f.append(vis_y_params_t_1)
                tac_y_params_t_1_ref = tac_y_params_t_1
                vis2tac_y_params_f.append(tac_y_params_t_1)
                lsttac_y_params_f.append(tac_y_params_t_1)
            ...
            tac_y_params_f.append(tac_y_params_t_1_ref) # Note here, the fused value is passed
        ...
        return (vis_prior_params_y_f, vis_y_params_f, vis_ys_f, vis_prior_params_z_f, vis_z_params_f,
                ...
                vis2tac_y_params_f, lsttac_y_params_f, tac2vis_y_params_f, lstvis_y_params_f)
