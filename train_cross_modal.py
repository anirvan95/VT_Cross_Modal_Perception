...
def main():
    ...
    parser.add_argument('--vis_stdx', default=1, type=float, help='standard deviation of visual observation')
    parser.add_argument('--vis_stdy', default=0.05, type=float, help='standard deviation of visual y space')
    parser.add_argument('--tac_stdx', default=1, type=float, help='standard deviation of tactile observation')
