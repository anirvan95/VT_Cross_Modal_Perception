...
def main():
    cmlf_base_results_path = os.path.join('results', 'crossmodallf', '03_07_21_13') # 03_10_00_38 # 03_10_19_08
    args = load_args_from_file(os.path.join(cmlf_base_results_path, 'args.txt'))
    noise_std = 0.1  # Adjust noise standard deviation as needed
    ...
    for i, checkpoint in enumerate(checkpoints):
        ...
        np.savez(os.path.join(cmlf_base_results_path, 'output_tac_noise', str(iteration) + '.npz'),
