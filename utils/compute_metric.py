...
import tcvae_utils.flows as flows
...
def elbo_decomposition_pendulum(vae, dataset_loader):
...
def mutual_info_metric_pendulum(vae, shapes_dataset):
    # TODO: Improve the MIG metric for continuous space of theta for pendulum
