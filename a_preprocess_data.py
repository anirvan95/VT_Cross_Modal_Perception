...
########################################################################################################################
base_dir = os.path.join('dataset', 'cm_dataset', 'raw')
vis_dump_dir = os.path.join('dataset', 'cm_dataset', 'dump', 'vision')
tactile_dump_dir = os.path.join('dataset', 'cm_dataset', 'dump', 'tactile')
stats_dump_dir = os.path.join('dataset', 'cm_dataset', 'dump', 'stats')
...
save_dir = os.path.join('dataset', 'cm_dataset', 'processed')
...
with open(os.path.join('results', 'tactile_min_max_values.pickle'), 'rb') as f:
